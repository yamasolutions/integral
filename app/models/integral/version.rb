...
module Integral
  ...
  class Version < ApplicationRecord
    ...
    def self.available_objects
      ...
      [Integral::Post, Integral::Category, Integral::Page, Integral::List, Integral::Storage::File, Integral::User].concat(Integral.additional_tracked_classes).each do |item|
