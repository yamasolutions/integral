...
Gem::Specification.new do |s|
  ...
  # Currently commented out as running on a ref which supports Rails 6 but is unreleased
  ...
  s.add_dependency 'client_side_validations', '~> 16.0' # Client-side validations
  s.add_dependency 'client_side_validations-simple_form', '~> 8.0' # Simpleform for Client-side validations gem
  ...
  s.add_dependency 'devise', '~> 4.7.0' # Authentication
  ...
  s.add_dependency 'haml-rails', '~> 2.0' # HAML
  ...
  # Currently commented out as running on a ref which supports Rails 6 but is unreleased
  # s.add_dependency 'paper_trail', '~> 10.?.0' # Audit trail
  ...
  s.add_development_dependency 'factory_bot_rails', '~> 5.0' # Create reusable object templates
  ...
  s.add_development_dependency 'rspec-rails', '~> 4.0.0.beta2' # Testing framework
  ...
  s.add_development_dependency 'capybara', '~> 3.29' # Acceptance testing framework
  ...
  s.add_development_dependency 'rubocop-rails', '~> 2.3' # Ruby static code analyzer
