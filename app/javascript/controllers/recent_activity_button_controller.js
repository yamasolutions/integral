...
export default class extends Controller {
  openModal(event) {
    ...
    if (modal) {
      ...
      form.querySelector("input[name='grid[user][]']").value = this.parseValue(this.element.dataset.recentActivityUser)
      form.querySelector("input[name='grid[object][]']").value = this.parseValue(this.element.dataset.recentActivityObject)
