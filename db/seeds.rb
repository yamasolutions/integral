...
Integral::Page.create!(title: 'Integral CMS - Demo Page',
                       ...
                       path: '/',
                       active_block_list: Integral::BlockEditor::BlockList.new(content: renderer.render('integral/pages/_demo', layout: false)),
                       status: 1)
...
if Integral.blog_enabled?
  ...
  Integral::Post.create!(title: 'Integral CMS - Demo Post',
                         ...
                         active_block_list: Integral::BlockEditor::BlockList.new(content: renderer.render('integral/posts/_demo', layout: false)),
                         slug: 'integral-demo',
                         user: user,
